...
export function WormholeLayout() {
  ...
  return (
    <div className={styles.container}>
      <PanelGroup direction={layout.tree.root.orientation === "vertical" ? "vertical" : "horizontal"}>
      ...
      <Fragment key={child.id}>
        ...
        <Panel>
          {child.tag === "window" ? (
            ...
            <PanelGroup direction={(child as LT.Stack).orientation === "vertical" ? "vertical" : "horizontal"}>
