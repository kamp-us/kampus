/**
 * @generated SignedSource<<d84c57ce57f009f5affe151762b7df79>>
...
export type LibraryStoriesFragment$data = {
  readonly id: string;
  readonly stories: {
  ...
  readonly " $fragmentType": "LibraryStoriesFragment";
};
export type LibraryStoriesFragment$key = {
  readonly " $data"?: LibraryStoriesFragment$data;
