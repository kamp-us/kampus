/**
 * @generated SignedSource<<050f354ea1fe96474e28d264b40813b6>>
...
return {
  ...
  "params": {
    "cacheID": "8bac376f33f25b86609241525e74a03c",
    "id": null,
    "metadata": {},
    "name": "LibraryStoriesPaginationQuery",
    "operationKind": "query",
    "text": "query LibraryStoriesPaginationQuery(\n  $after: String\n  $first: Int = 10\n  $id: String!\n) {\n  node(id: $id) {\n    __typename\n    ...Library_stories_2HEEH6\n    id\n  }\n}\n\nfragment Library_stories_2HEEH6 on Library {\n  stories(first: $first, after: $after) {\n    edges {\n      node {\n        id\n        ...Library_story\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    totalCount\n  }\n  id\n}\n\nfragment Library_story on Story {\n  id\n  url\n  title\n  description\n  createdAt\n  tags {\n    id\n    name\n    color\n  }\n}\n"
  }
};
})();
