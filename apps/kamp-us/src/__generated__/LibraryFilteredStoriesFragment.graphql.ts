...
export type LibraryFilteredStoriesFragment$data = {
  readonly id: string;
  ...
  readonly " $fragmentType": "LibraryFilteredStoriesFragment";
};
export type LibraryFilteredStoriesFragment$key = {
  readonly " $data"?: LibraryFilteredStoriesFragment$data;
  readonly " $fragmentSpreads": FragmentRefs<"LibraryFilteredStoriesFragment">;
};

import LibraryFilteredStoriesPaginationQuery_graphql from './LibraryFilteredStoriesPaginationQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": LibraryFilteredStoriesPaginationQuery_graphql,
      "identifierInfo": {
        "identifierField": "id",
