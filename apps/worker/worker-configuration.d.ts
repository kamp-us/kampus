/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d2eeb033d0d8f927f70c58a2f340f904)
// Runtime types generated with workerd@1.20260131.0 2025-12-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Pasaport" | "WebPageParser" | "Library" | "WormholeDO" | "WormholeSandbox";
	}
	interface Env {
		ENVIRONMENT: "development";
		API_KEY_PREFIX: "kampus_";
		PASAPORT: DurableObjectNamespace<import("./src/index").Pasaport>;
		WEB_PAGE_PARSER: DurableObjectNamespace<import("./src/index").WebPageParser>;
		LIBRARY: DurableObjectNamespace<import("./src/index").Library>;
		WORMHOLE_DO: DurableObjectNamespace<import("./src/index").WormholeDO>;
		WORMHOLE_SANDBOX: DurableObjectNamespace<import("./src/index").WormholeSandbox>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "API_KEY_PREFIX">> {}
}
declare module "*.sql" {
	const value: string;
