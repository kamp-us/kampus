/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 47051553e7249eb679b6580114504fe0)
// Runtime types generated with workerd@1.20251217.0 2025-12-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Pasaport";
	}
	interface Env {
		ENVIRONMENT: "development";
		API_KEY_PREFIX: "kampus_";
		SUPERUSER_EMAIL: "superuser@kampus.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "API_KEY_PREFIX" | "SUPERUSER_EMAIL" | "SUPERUSER_PASSWORD">> {}
}
declare module "*.sql" {
	const value: string;
