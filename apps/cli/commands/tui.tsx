import {bold, createCliRenderer, fg, italic, TextAttributes, t} from "@opentui/core";
...
export const App = () => {
	...
	return (
		<box style={{padding: 2, flexDirection: "column"}}>
			...
			<box
				title="Password"
				style={{border: true, width: 40, height: 3, marginTop: 1, marginBottom: 1}}
			>
				<input
